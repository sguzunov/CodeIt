...
namespace CodeIt.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(CodeItUserManager userManager, CodeItSignInManager signInManager)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await SignInManager.PasswordSignInAsync(userName: model.Username, password: model.Password, isPersistent: model.RememberMe, shouldLockout: false);
            switch (result)
            {
